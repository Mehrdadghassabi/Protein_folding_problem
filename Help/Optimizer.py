...
def get_Sample_Aminoacids_information():
...
def get_populationfitness_dic(popu,FitnessFunctionObj):
    population_dic = []
    for indiv in popu:
...
def train_RotationAndDelta(generation,found,mio,llambda,Pc,Pm,max_number_of_generation,HowTheyCombined,HowSulfurCombined,FitnessFunctionObj,good_fitness):
    population = generate_population_with_fixed_Combination(FitnessFunctionObj, 100,HowTheyCombined)
    population_dic = get_populationfitness_dic(population,FitnessFunctionObj)
    ...
    while generation <= max_number_of_generation and not found:
          ...
          energy = FitnessFunctionObj.caculateEnergy(best_indiv[0],best_indiv[1], HowSulfurCombined)
          ...
          offsprs = recombination(parents_pair,HowTheyCombined, Pc)
          offsprs = mutation(offsprs, Pm, fitness)
          population_dic = get_populationfitness_dic(population + offsprs,FitnessFunctionObj)
          population = fit_population(population_dic,llambda)
          if fitness < good_fitness :
             found = True
    return best_indiv[1]

def train_combination(generation,found,mio,llambda,Pc,Pm,max_number_of_generation,fixed_RotationAndDelta,HowSulfurCombined,FitnessFunctionObj):
    population = generate_population_with_fixed_RotationAndDelta(FitnessFunctionObj, 100,fixed_RotationAndDelta)
    population_dic = get_populationfitness_dic(population,FitnessFunctionObj)
    population = fit_population(population_dic,llambda)
    population[0][0], _ =RandomInput(FitnessFunctionObj)
    ...
    while generation <= max_number_of_generation and not found:
          ...
          population_dic = get_populationfitness_dic(population + offspr,FitnessFunctionObj)
          population = fit_population(population_dic,llambda)
    return best_indiv[0]

def train_sulfurcomb(generation,found,mio,llambda,Pc,Pm,max_number_of_generation,
                     fixed_Combination,fixed_RotationAndDelta,FitnessFunctionObj):
    ...
    population_dic_SulfurCombinations = get_populationfitness_dic(population,FitnessFunctionObj)
    ...
    while generation <= max_number_of_generation and not found:
          ...
          population_dic_SulfurCombinations = get_populationfitness_dic(population + offspr,FitnessFunctionObj)
          population = fit_population(population_dic_SulfurCombinations,llambda)
    return best_indiv[2]

def optimize_solution(FitnessFunctionObj,good_fitness): 
    init_point = RandomInput(FitnessFunctionObj)
    fixed_RotationAndDelta = init_point[1]
    fixed_Combination = init_point[0]
    HowSulfurCombined = train_sulfurcomb(generation= 1,found= False,mio= 20,llambda= 20,Pc= 0.08,
      Pm= 0.05,max_number_of_generation=30, fixed_Combination=fixed_Combination,
                                          fixed_RotationAndDelta=fixed_RotationAndDelta,FitnessFunctionObj=FitnessFunctionObj)
    print('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
    
       
    HowTheyCombined = train_combination(generation= 1,found= False,mio= 20,llambda= 20,Pc= 0.8,Pm= 0.05,
      max_number_of_generation=30,fixed_RotationAndDelta=fixed_RotationAndDelta,HowSulfurCombined=HowSulfurCombined,FitnessFunctionObj=FitnessFunctionObj)
    print('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
    
    
    HowRotationAndDeltaOccured = train_RotationAndDelta(generation= 1,found= False,mio= 20,llambda= 20,
      Pc= 0.8,Pm= 0.05,max_number_of_generation=3000,HowTheyCombined=HowTheyCombined,HowSulfurCombined=HowSulfurCombined,FitnessFunctionObj=FitnessFunctionObj,good_fitness=good_fitness)
    print('$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$')
    
    return [HowTheyCombined,HowRotationAndDeltaOccured,HowSulfurCombined]
    
  
if __name__=="__main__":
    M_Amino,F_Amino,K_Amino,C_Amino,ResNames = get_Sample_Aminoacids_information()
    FitnessFunctionObj = ff.FitnessFunction([M_Amino, F_Amino, K_Amino, C_Amino], ResNames)    
    #optimize_solution(FitnessFunctionObj)
    sample3_indiv_fitness(FitnessFunctionObj) 
    #print("Done")
