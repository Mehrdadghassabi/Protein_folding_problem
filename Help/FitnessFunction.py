                        ...
                        if Combinations[index]==1:
                            ...
                            if SSIndex < OIndex:
                                AminoAcidsObjects[AminoIdForSulfur-1].\
                                    AtomsCombination[SSIndex-AminoAcidsObjects[AminoIdForSulfur-1].\
                                        FirstAtomIndex].append(SIndex)
                            elif SIndex < SSIndex:
                                AminoAcidsObjects[AminoIdForSulfur-1].\
...
if __name__=="__main__":
    ...
    print(FitnessFunctionObj.caculateEnergy(HowTheyCombined, HowRotationAndDeltaOccured, SulfurCombinations=[0, 1]))